...
<div class="jumbotron jumbotron-fluid p-4">
    <div class="row">
        <div class="col-md-9">
            <h1>Welcome Back,</h1>
            <p style="text-transform:uppercase; font-size:22px; color:tomato">{{ $data->first_name }} {{ $data->last_name }}</p>
        </div>
        <div class="col-md-3">
            <i style="font-size:50px; color:tomato" class="fa fa-user-o" aria-hidden="true"></i>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
            <p class="mb-0 text-center text-lg-start">© 2023-<span class="current-year"></span> <a
                    class="text-primary fw-normal" href="javascript:;" target="">Yonevas</a></p>
        </div>
