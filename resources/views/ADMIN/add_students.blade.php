...
<body>
      ...
      <h1 style="color:#5e72e4; font-style:italic; font-family:broadway; font-size:32px; margin-top:30px; border-radius:70px 10px 70px 10px; background-color:white; padding:15px; margin-bottom:20px">ADD STUDENTS</h1>
   ...
   @csrf
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" minlength="8" name="password" class="form-control input-style" id=""
                                    placeholder="Enter Student Password" required="required">
                            </div>
                        </div>
            ...
            <div id="ifYes" style="visibility:hidden">
                        ...
                        <span style="font-size:22px" class="font-weight-bold pt-5 pb-3">4. Social Media Pages<span style="color:red">(Not Compulsory)</span><br><br>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                        ...
                        <span style="font-size:22px" class="font-weight-bold pt-5 pb-3">5. Select Course</span><br><br>
