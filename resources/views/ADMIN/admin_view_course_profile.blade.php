    ...
    <div class="row">
        ...
        <div class="row gutters-sm">
            ...
            <div class="col-md-8 mb-3">
                ...
                <p style="color:grey; font-size:22px"> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Saepe
                    unde modi suscipit vel neque laborum facere quia, officia nam atque maiores dolor nisi obcaecati
                    tempora, placeat, consectetur qui? Officia eligendi vitae, dicta quam mollitia quisquam veniam
                    deserunt, et cumque a inventore, facilis dolorem ratione rerum earum vel rem temporibus quae
                    repellat quasi? Voluptate fugiat omnis pariatur repellendus, ipsam, nam, ducimus exercitationem
                    cumque maiores sed eius nisi quam eveniet quasi odio laudantium placeat libero repellat quibusdam
                    voluptatem aliquam.</p> <br><br><br>


                <div>
                    <img class="" style="width:300px; heigh:500px" height="500" width="500"
                        src="{{ asset('diplomaCourseImages/' . $join->image) }}" alt="Course Image" />
