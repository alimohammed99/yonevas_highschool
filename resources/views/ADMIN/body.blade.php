{{-- <div class="toast" data-autohide="false">
    ...
    <div class="toast-body">
        Some text inside the toast bodyyyyyyyyyyyy
    </div>
</div> --}}

<div class="alert alert-info alert-dismissible">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Welcome!</strong> <span style="" class="ml-2 badge badge-danger">{{ $regNotCompleteQuery }}</span> new
    Users haven't completed their registration. Kindly click on the <a href="{{ url('view_new_users') }}"><span class="text-danger">'New users'</span></a> tab to view them.
</div>
                ...
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        <div class="icon-shape icon-shape-primary rounded me-4 me-sm-0">
                            <a href="{{ url('view_new_users') }}"><svg xmlns="http://www.w3.org/2000/svg" width="" height="" fill="currentColor" class="bi bi-person-add" viewBox="0 0 16 16">
                                    <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0Zm-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" />
                                    <path d="M8.256 14a4.474 4.474 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10c.26 0 .507.009.74.025.226-.341.496-.65.804-.918C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4s1 1 1 1h5.256Z" />
                                </svg></a>
                        </div>
                        <div class="d-sm-none">
                            <a href="{{ url('view_new_users') }}" title="">
                                <h2 style="font-size:20px" class="h5">New Users</h2>
                            </a><br>
                            <h3 style="border-bottom: 5px double tomato; padding:5px" class="fw-extrabold mb-1">{{ $regNotCompleteQuery }}</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <a href="{{ url('view_new_users') }}">
                                <h2 style="font-size:20px" class="h6 text-gray-400 mb-0">New Users</h2>
                            </a><br>
                            <h3 style="border-bottom: 5px double tomato; padding:5px" class="fw-extrabold mb-2">{{ $regNotCompleteQuery }}</h3>
                        </div>
                ...
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        <div class="icon-shape icon-shape-secondary rounded me-4 me-sm-0">
                            <a href="{{ url('view_students') }}"> <svg class="icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="d-sm-none">
                            <a href="{{ url('view_students') }}">
                                <h2 style="font-size:20px" class="fw-extrabold h5">Verified Users</h2>
                            </a><br>
                            <h3 style="border-bottom: 5px double tomato; padding:5px" class="mb-1">{{ $regCompleteQuery }}</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <a href="{{ url('view_students') }}">
                                <h2 style="font-size:20px" class="h6 text-gray-400 mb-0">Verified Users</h2>
                            </a><br>
                            <h3 style="border-bottom: 5px double tomato; padding:5px" class="fw-extrabold mb-2">{{ $regCompleteQuery }}</h3>
                        </div>
                ...
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        <div class="icon-shape icon-shape-tertiary rounded me-4 me-sm-0">
                            <a href="{{ url('view_job_applicants') }}"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-briefcase-fill" viewBox="0 0 16 16">
...
<footer class="bg-white rounded shadow p-5 mb-4 mt-4">
    <div class="row">
        <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
            <p class="mb-0 text-center text-lg-start">© 2023-<span class="current-year"></span> <a class="text-primary fw-normal" href="javascript:;" target="">Yonevas</a></p>
        </div>
        <div class="col-12 col-md-8 col-xl-6 text-center text-lg-start">
            <!-- List -->
            <ul class="list-inline list-group-flush list-group-borderless text-md-end mb-0">
                {{-- <li class="list-inline-item px-0 px-sm-2">
                    <span style="font-size:18px" class="text-success">For enquires/complaints, contact:</span> <br> <a
                        style="font-size:18px" class="text-danger"
                        href="mailto:inquires@yonevas.institute">inquires@yonevas.institute</a>
                </li> --}}
                {{-- <li class="list-inline-item px-0 px-sm-2">
