            ...
            <div class="d-flex align-items-center">
                <div class="avatar-lg me-4">
                    <img src="../../assets/img/team/profile-picture-3.jpg"
                        class="card-img-top rounded-circle border-white" alt="Logo">
                </div>
                {{-- <div class="d-block">
                                            ...
                                            <a href="#"
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col ps-0 ms-2">
                                                        ...
                                                        <p class="font-small mt-1 mb-0">New message: "Hey, what's up?
                                                            All set for the presentation?"</p>
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="#"
                          ...
                          <div class="text-end">
                            <small>2 hrs ago</small>
                                                        ...
                                                        <p class="font-small mt-1 mb-0">New message: "We need to
                                                            improve the UI/UX for the landing page."</p>
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="#"
