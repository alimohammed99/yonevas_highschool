...
<body>
      ...
      <h1 style="color:#5e72e4; font-style:italic; font-family:broadway; font-size:32px; margin-top:30px; border-radius:70px 10px 70px 10px; background-color:white; padding:15px; margin-bottom:20px">EDIT STAFFS</h1>
      ...
      <div class="card card_border mt-2 py-2 mb-4">
                ...
                <form class="form-horizontal" action="{{url('update_staffs', $data->id)}}" method="post" enctype="multipart/form-data">
