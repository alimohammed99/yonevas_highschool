...
<div class="container emp-profile">
  ...
  <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
      ...
      <div class="d-flex"> <a href="javascript:;" style="cursor:not-allowed; color:black; box-shadow:black 7px 7px 9px" class="mt-0 btn btn-warning">Staff has no CV <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-emoji-frown" viewBox="0 0 16 16">
