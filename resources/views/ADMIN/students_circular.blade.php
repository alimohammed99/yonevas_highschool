...
<body>
  ...
  <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
            ...
            <form style="width:100%" class="form" action="{{url('upload_students_circular')}}" method="post" enctype="multipart/form-data">
          @csrf
...
@foreach($data as $data)
    ...
    <td>{{$data->title}}</td>
    <td>{{$data->content}}</td>
    <td class=""><a onclick="return confirm('Are you sure?')"  class="btn btn-danger" href="{{url('delete_students_circular', $data->id)}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
