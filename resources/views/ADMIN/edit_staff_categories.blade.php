...
<body>
      ...
      <form style="width:100%" class="form" action="{{url('update_staff_categories', $data->id)}}" method="post" enctype="multipart/form-data">
          @csrf
        ...
        <label style="font-size:22px" for="price">Category</label> <br>
          <input style="color:tomato; border-radius:30px; padding:30px;  width:40%" class="form-control" type="text" name="category_name" value="{{$data->teaching_or_nonteaching}}" required="required">
        </div>
     ...
     <div class="form-group">
        ...
        <div class="form-group">
      <a class="btn btn-info" href="{{url('staff_categories')}}">View all Categories</a>
        </div>
