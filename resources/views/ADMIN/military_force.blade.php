...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div style="border-radius:50px" class="modal-content">
      ...
      <form style="width:" class="form" action="{{url('upload_military_force')}}" method="post" enctype="multipart/form-data">
          @csrf
        ...
        <label for="price">Status</label>
          <input style="color:tomato" class="form-control" type="text" name="military_force" placeholder="Add answer" required="required">
        </div>
<br>
