...
<body>
      ...
      <form style="width:100%" class="form" action="{{url('update_genders', $data->id)}}" method="post" enctype="multipart/form-data">
          @csrf
        ...
        <label style="font-size:22px" for="price">Gender</label> <br>
          <input style="color:tomato; border-radius:30px; padding:30px;  width:40%" class="form-control" type="text" name="gender_name" value="{{$data->gender_name}}" required="required">
        </div>
     ...
     <div class="form-group">
        ...
        <div class="form-group">
      <a class="btn btn-info" href="{{url('genders')}}">View all Genders</a>
        </div>
