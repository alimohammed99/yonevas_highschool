...
<html lang="en" dir="ltr" prefix="content: http://purl.org/rss/1.0/modules/content/  dc: http://purl.org/dc/terms/  foaf: http://xmlns.com/foaf/0.1/  og: http://ogp.me/ns#  rdfs: http://www.w3.org/2000/01/rdf-schema#  schema: http://schema.org/  sioc: http://rdfs.org/sioc/ns#  sioct: http://rdfs.org/sioc/types#  skos: http://www.w3.org/2004/02/skos/core#  xsd: http://www.w3.org/2001/XMLSchema# ">
  <head>
    <meta charset="utf-8" /><script type="text/javascript">(window.NREUM||(NREUM={})).init={ajax:{deny_list:["bam.nr-data.net"]}};(window.NREUM||(NREUM={})).loader_config={licenseKey:"f639074655",applicationID:"117349135"};/*! For license information please see nr-loader-rum-1220.min.js.LICENSE.txt */
...
</noscript><script src="assets/js/hotjar.script.js?rmv1i3"></script>
...
<link rel="icon" href="assets/img/logo2.png" type="image/vnd.microsoft.icon" />
...
<script src="assets/js/modernizr-additional-tests.js?v=3.11.7"></script>
  ...
  <div class="header-responsive clearfix hidden-on-desktop">
    ...
    <img src="assets/img/logo2.png" style="height: 25px; width: 50px; object-fit: contain;" alt="Home" class="hidden-on-mobileTabletOnly" />
    <img src="assets/img/logo2.png" style="height: 50x; width: 50px; object-fit: contain;" alt="Home" class="hidden-on-desktop" />
      </a>
  ...
  <ul class="menu">
                <li class="menu-item">
                    ...
                    <li class="menu-item">
                      <a href="javscript:;" data-drupal-link-system-path="node/717">Canvas</a>
                    </li> 
  ...
  <div class="header-main js-nav-menu bg--white text--dark">
    <div class="container">
      <div class="header-main__left hidden-on-mobileTabletOnly">
        <div class="logosite">
              <a href="{{ url('/') }}">  <img src="assets/img/logo2.png" alt=""/></a>
                <h3>Yonevas Open University</h3>
               </div>
      </div>
...
<div class="main-menu js-expanded-menu ">
                <ul class="menu">
                  ...
                  <li class="menu-item menu-item--expanded expanded-menu lv-1">
                    ...
                    <div class="expanded-menu__menu-child">
                      <ul class="menu">
                        <li class="menu-item">
                          <a href="{{ url('student') }}" data-drupal-link-system-path="node/27">Student Life</a>                        
                        </li>               
                        <li class="menu-item">
                          <a href="javascript:;" data-drupal-link-system-path="node/27">Study Abroad</a>                        
                        </li>               
                        <li class="menu-item">                          
                          <a href="javascript:void(0)" data-drupal-link-system-path="node/27">Career Center</a>                          
                        </li>               
                        <li class="menu-item">                         
                          <a href="{{ url('employment') }}" data-drupal-link-system-path="node/27">Employment Oppurtunity</a>
                        </li>               
                      </ul>
                    </div>      
                  </li>
                  <li class="menu-item menu-item--expanded expanded-menu lv-1">
                    ...
                    <div class="expanded-menu__menu-child">
                      <ul class="menu">
                        ...
                        <li class="menu-item">                          
                          <a href="javascript:;" data-drupal-link-system-path="node/27">Alumni</a>                          
                        </li>               
                        <li class="menu-item">                          
                          <a href="javascript:;" data-drupal-link-system-path="node/27">Board Members</a>                          
                        </li>               
                        <li class="menu-item">                          
                  ...
                  <li class="menu-item menu-item--expanded expanded-menu lv-1">
                    <a href="javascript:void(0)" tabindex="-1" data-drupal-link-system-path="node/27">Faculty and Department</a>
                    <div class="expanded-menu__menu-child">
                      <ul class="menu">
                        <li class="menu-item">
                          <a href="javascript:void(0)" data-drupal-link-system-path="node/27">Social Science</a>                                                    
                        </li>               
                        <li class="menu-item">                          
                          <a href="javascript:void(0)" data-drupal-link-system-path="node/27">Business and Management</a>                                                 
                        </li>               
                        <li class="menu-item">                          
                          <a href="javascript:void(0)" data-drupal-link-system-path="node/27">Art, Media & Design</a>                          
                        </li>               
                      </ul>
                    </div>      
                  </li>
    ...
    <ul class="menu">
                    ...
                    <li class="menu-item">
                      <a href="javascript:;" data-drupal-link-system-path="node/717">Canvas</a>
                    </li>    
...
<div id="block-breadcrumbs" class="breadcrumb-block--orange block breadcrumb-block block-system block-system-breadcrumb-block">
  ...
  <div class="feature-banner has-image">
        <div class="feature-banner__image">    <picture>
                    <source srcset="assets/img/admission-banner.jpeg?h=4da1fa98&amp;itok=yaN7h3BB 1x" media="screen and (min-width: 90em)" type="image/png"/>
                <source srcset="assets/img/admission-banner.jpeg?h=4da1fa98&amp;itok=ODq8_SVs 1x" media="screen and (min-width: 64em)" type="image/png"/>
                <source srcset="assets/img/admission-banner.jpeg?h=4da1fa98&amp;itok=kGzeO0oN 1x" media="(min-width: 0em)" type="image/png"/>
                    <img src="assets/img/admission-banner.jpeg?itok=mkYpVdvv" alt="Pixels Bench" title="pixel_bench_crop.png" typeof="foaf:Image" />
      ...
      <div class="container">
        <div class="feature-banner__content text--center bg--black text--white">
                    <h1 class="feature-banner__title">Accounting</h1>
...
<article data-history-node-id="20442" role="article" about="/courses/2023/school-year/ocra1" class="content-group course-detail no-link-back-top">
  ...
  <div class="container">
      ...
      <div class="article__link article__link--top"><a href="/course-catalog" class="link link--arrow-left link--semibold">Back to search results</a></div>
          ...
          <div class="article__body list-in-article">
            <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item"><p>Accounting majors learn the skills necessary for success in a dynamic global business environment. Built upon the King’s College innovative student learning assessment program, competency based course content focus learning upon the liberal learning and technical competencies which accounting professionals use as part of their contribution to the success of business enterprise. The college core curriculum, business foundation courses, and major courses emphasize an awareness of personal values, character development, and an understanding of liberal learning competencies applied in a business context, such as communication, analytical thinking, team building, and strategic planning.</p>
                                ...
                                <div class="article">
      <div class="article__link article__link--top"><a href="/course-catalog" class="link link--arrow-left link--semibold">Back to search results</a></div>
          <h3 class="article__title">How to get Started</h3>
          <div class="article__body list-in-article">
            <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item"><p>You can start the Accounting program in the Feb. or Sept terms. Follow these steps to finish your application:</p>
            <ol>
            <li>Want to learn more about YOU? Come see how YOU will help you achieve Your Path to Possible! <b>Schedule a campus visit!</b> </li>
            <li>Need help exploring career opportunities or navigating the admissions process? <a href="#"><b>Schedule an appointment with an Admissions Counselor.</b></a> </li>
            <li>Ready to apply? Complete an Application for Admission.</li>
            </ol>    
</div>
      </div>
    ...
    <div class="content-right bg--light-sandstone">
      <div class="box-list">
      <div class="box-list__item">
      <div class="box-date">
      <h6 class="box-date__title text--primary-color">Estimated Cost</h6>
    <div class="box-date__group">
          <div class="box-date__day">
            <div class="field field--name-field-course-number field--type-string field--label-hidden field__item">&#8358;336,460</div>
      </div>
          </div>
</div>
    </div>
        <div class="box-list__item">
      <div class="box-date">
      <h6 class="box-date__title text--primary-color">Program Length</h6>
    <div class="box-date__group">
          <div class="box-date__day">
            <div class="field field--name-field-level-ref field--type-entity-reference field--label-hidden field__item">8 Semesters</div>
      </div>
          </div>
</div>
    </div>
              <div class="box-list__item">
      <div class="box-text ">
  <h6 class="box-text__title text--primary-color">Medium</h6>
      <div class="box-text__date">
            <div class="field field--name-field-semester-ref field--type-entity-reference field--label-hidden field__item">Virtual Learning</div>
      </div>
    </div>
    </div>
        <div class="box-list__item">
      <div class="box-text ">
  <h6 class="box-text__title text--primary-color">Start Term(s)</h6>
      <div class="box-text__date">
            <div class="field field--name-field-credit-hours field--type-float field--label-hidden field__item">FEB./SEPT</div>
      </div>
    </div>
    </div>
                      <div class="box-list__item">
      <div class="box-text ">
  <h6 class="box-text__title text--primary-color">Awards offered</h6>
      <div class="box-text__date">
            <div class="field field--name-field-subject-ref field--type-entity-reference field--label-hidden field__item">Bachelor Degree</div>
      </div>
    </div>
    </div>
        <div class="box-list__item">
      <div class="box-text ">
  <h6 class="box-text__title text--primary-color">Prerequisites</h6>
      <div class="box-text__date">
            <div class="field field--name-field-prerequisites field--type-string field--label-hidden field__item">Democracy, Freedom, and the Rule of Law (ODFRL) or placement assessment</div>
      </div>
    </div>
    </div>
    </div>
      ...
      <div class="field__item" tabindex="0">
          ...
          <div >
            ...
            <div class="container">
                    <h1 class="box-icon__big-title text--center">
                      <div class="field field--name-field-title field--type-string field--label-hidden field__item capitalize">Program Requirements</div>
                </h1>
          <div class="text-columns__grid text-columns__grid--2-items">
                            
                            <div class="text-columns__item ">
                                  <h3 class="text-columns__title">Major Requirements (9 Credits)</h3>
                              
                                  <div class="text-columns__body">
                                      <div class="clearfix text-formatted field field--name-field-body-wysiwyg field--type-text-long field--label-hidden field__item">
                                          <p><i>The following courses will be used to fulfill CORE requirements:</i></p>                              
          
                                          <ul style="list-style: none;">
                                             <li>ECON 111 - Principles of Economics: Macro</li>
                                             <li>MATH 123 - Finite Mathematics and Business Analytics</li>
                                             <li>MSB 287 - Business Ethics</li>
                            ...
                            <div class="text-columns__item ">
                                  <h3 class="text-columns__title">Business Foundations (42 Credits)</h3>
                              
                                  <div class="text-columns__body">
                                        <div class="clearfix text-formatted field field--name-field-body-wysiwyg field--type-text-long field--label-hidden field__item">
                                            <p><i>The following courses will also be included:</i></p>
                                        <ul>
                                            <li>CIS 110 - Introduction to Business Information Systems</li>                     
                                            <li>ECON 112 - Principles of Economics: Micro </li>                     
                                            <li>ECON 221 - Statistics and Predictive Analytics
</li>                     
                                            <li>IB 241 - Globalization
</li>                     
                                            <li>MSB 100 - Introduction to Business </li>                     
                                            <li>MSB 110 - Introduction to Financial Reporting
</li>                     
                                            <li>MSB 120 - Introduction to Management Control and Planning
</li>                     
                                        </ul>
                      ...
                      <div >
                        <div class="text-columns  bg--image text--dark ">
                        <div class="container">
                            <div class="text-columns__grid text-columns__grid--2-items">
                                        
                      <div class="text-columns__item ">
                        <h3 class="text-columns__title">Major Seqeunce Requirements (29 Credits)</h3>
                              ...
                              <div class="text-columns__body">
                                  <div class="clearfix text-formatted field field--name-field-body-wysiwyg field--type-text-long field--label-hidden field__item">
                                      ...
                                      <ul style="list-style: none;">
                                         <li>ACCT 230 Tax Accounting</li>
                                         <li>ACCT 240 Intermediate Accounting I</li>
                                         <li>ACCT 240L Intermediate Accounting I Lab</li>
                                         <li>ACCT 301 Intermediate Accounting II</li>
                                         <li>ACCT 302 Intermediate Accounting III</li>
                                         <li>ACCT 310 Advanced Financial Accounting</li>
                      ...
                      <div class="text-columns__item ">
                            <h3 class="text-columns__title">Electives</h3>
                        
                            <div class="text-columns__body">
                                  <div class="clearfix text-formatted field field--name-field-body-wysiwyg field--type-text-long field--label-hidden field__item">
                                    <p>Elective (6 Credits) - Students may choose from any elective course offered/accepted by the College including non-business courses.</p>    
                      </div>
                            </div>
          ...
          <div class="text-columns__grid text-columns__grid--2-items">
                            ...
                            <div class="text-columns__item ">
                                  <h3 class="text-columns__title">Minor Sequence Requirements (6 Courses - 16 Credits)</h3>
                              
                                  <div class="text-columns__body">
                                      <div class="clearfix text-formatted field field--name-field-body-wysiwyg field--type-text-long field--label-hidden field__item">
                                          <p><i>Monitoring of student progress in pursuing a minor in Accounting is necessary to enhance the student learning experience. Therefore, a written declaration must be submitted by the student to the Registrar.</i></p>                              
                                          ...
                                          <ul style="list-style: none;">
                                             ...
                                             <li>ACCT 301 Intermediate Accounting II</li>
                                             <li>ACCT 302 Intermediate Accounting III</li>
                                             <li>ACCT 340 Advanced Managerial Accounting</li>                                             
                                          </ul>
                                          <p><i>In fulfilling the requirements of the minor, students are required to complete more than fifty percent of the coursework at Yonevas Open University.</i></p>
                                      </div>
                                  </div>
                            ...
                            <div class="text-columns__item ">
                                  <h3 class="text-columns__title">Minor Sequence Requirements - Forensic Accounting(6 Courses - 18 Credits)</h3>
                              
                                  <div class="text-columns__body">
                                        <div class="clearfix text-formatted field field--name-field-body-wysiwyg field--type-text-long field--label-hidden field__item">
                                            <p><i>Monitoring of student progress in pursuing a minor in Accounting is necessary to enhance the student learning experience. Therefore, a written declaration must be submitted by the student to the Registrar.</i></p>
                                        <ul>
                                            <li>MSB 110 Introduction to Financial Accounting</li>                     
                                            <li>MSB 120 Introduction to Management Accounting and Planning</li>                     
                                            <li>ACCT 210 Fraud Examination I: Forensic and Investigative Accounting</li>                     
                                            <li>ACCT 211 Fraud Examination II: Forensic and Investigative Accounting</li>                     
                                            <li>ACCT 230 Tax Accounting</li>                     
                                            <li>ACCT 460 Advanced Federal Taxation</li>                     
                                        </ul>
...
<div id="block-dynamicfooterfirstblock" class="block block-spcs-domain block-dynamic-footer-first-block">
      ...
      <div class="logo-footer branding">
        <a class="logo" href="https://ohs.stanford.edu">
          <img src="assets/img/logo2.png" style="height: 100px; width: 50px; object-fit: contain;" alt="Footer logo" width="160" height="34"/>
        </a>
  ...
  <div class="support-us">
    ...
    <a class="btn btn--small btn--ripe-lemon" href="/giving">Make a Gift</a>
  </div>
...
<p><a href="/contact-us" target="_blank">Contact Yonevas Open University</a></p></div>
  ...
  <div class="social-links icon-bg-white">
    <ul>
          ...
          <a class="icon-facebook" href="#" title="Facebook">Facebook</a>
                      ...
                      <li>
          <a class="icon-camera-2" href="#" title="Camera 2">Camera 2</a>
        </li>
          </ul>
  </div>
    ...
    <h3 id="block-dynamicfooterthirdblock-menu" class="footer-panel__title">Navigate</h3>
        ...
        <a href="about.html" data-drupal-link-system-path="node/22">About</a>
                ...
                <li class="menu-item">
        <a href="program.html" data-drupal-link-system-path="node/884">Programs</a>
              </li>
                <li class="menu-item">
        <a href="">Academics</a>
              </li>
                <li class="menu-item">
        <a href="/questions" data-drupal-link-system-path="node/717">Student Life</a>
              </li>
                <li class="menu-item">
        <a href="/questions" data-drupal-link-system-path="node/717">Cost & Aid</a>
              </li>
                <li class="menu-item">
        <a href="/questions" data-drupal-link-system-path="node/717">Partnership</a>
              </li>
                <li class="menu-item">
        <a href="admission.html" data-drupal-link-system-path="node/717">Admissions</a>
              </li>
                <li class="menu-item">
        <a href="/questions" data-drupal-link-system-path="node/717">Virtual Assistance</a>
              </li>
                <li class="menu-item">
...
<div id="block-copyright" class="block block-block-content block-block-contente1fe857b-e8b5-4803-82f7-b71f368652e9">
  ...
  <div class="footer-global__copyright">
            ...
            <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item"><p>© Yonevas Open University.</p></div>
    ...
    <script type="application/json" data-drupal-selector="drupal-settings-json">{"path":{"baseUrl":"\/","scriptPath":null,"pathPrefix":"","currentPath":"node\/629","currentPathIsAdmin":false,"isFront":true,"currentLanguage":"en"},"pluralDelimiter":"\u0003","suppressDeprecationErrors":true,"ajaxPageState":{"libraries":"classy\/base,classy\/messages,classy\/node,core\/normalize,core\/picturefill,domain_base_color\/main_ohs,extlink\/drupal.extlink,paragraphs\/drupal.paragraphs.unpublished,spcs\/feature-banner-carousel,spcs\/global-js,spcs\/global-styling,system\/base,video_embed_field\/responsive-video","theme":"spcs","theme_token":null},"ajaxTrustedUrl":{"form_action_p_pvdeGsVG5zNF_XLGPTvYSKCf43t8qZYSwcfZl2uzM":true},"data":{"extlink":{"extTarget":true,"extTargetNoOverride":false,"extNofollow":false,"extNoreferrer":false,"extFollowNoOverride":false,"extClass":"0","extLabel":"(link is external)","extImgClass":false,"extSubdomains":false,"extExclude":"","extInclude":"","extCssExclude":"","extCssExplicit":"","extAlert":false,"extAlertText":"This link will take you to an external web site. We are not responsible for their content.","mailtoClass":"0","mailtoLabel":"(link sends email)","extUseFontAwesome":false,"extIconPlacement":"append","extFaLinkClasses":"fa fa-external-link","extFaMailtoClasses":"fa fa-envelope-o","whitelistedDomains":null}},"user":{"uid":0,"permissionsHash":"50089a5f011b5b9a54fa8c2bf7a41281b226ce0f84fceddfbe7a1f473fbf38a7"}}</script>
<script src="assets/js/js_iPxEG5lcgpgUc64NbihYYKxdRXqPwZ2H2Eh-fxB8WG8.js"></script>

  <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"f639074655","applicationID":"117349135","transactionName":"ZQAENhRUV0EEB00PV1xKJwESXFZcShRYAV1tBgcBDlA=","queueTime":0,"applicationTime":27,"atts":"SUcHQFxORE8=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
