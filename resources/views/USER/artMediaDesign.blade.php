...
<div class="feature-banner has-image">
    ...
    <div class="container">
      <div class="feature-banner__content text--center bg--black text--white">
                  <h1 class="feature-banner__title">Arts, Media & Design</h1>
              </div>
    </div>
  </div>
</div>
...
<div class="container">
  <h1 class="block-stats__big-title text--center capitalize">Arts, Media & Design Courses</h1>
<div class="block-stats__inner">
    <div class="block-stats__list">
      <ul id="boxes-f">
        <li class="fm">
                <a class="hvr-sweep-to-right ftiles" href="{{ route('graphics-design-media-arts') }}"><span class="blurb2">Graphic Design</span></a>
              </li>
              <li class="fm">
          <a class="hvr-sweep-to-right ftiles" href="javascript:void(0)"><span class="blurb2">Theatre Arts</span></a>
        </li>
        <li class="fm">
          <a class="hvr-sweep-to-right ftiles" href="javascript:void(0)"><span class="blurb2">Creative Leadership</span></a>
        </li>
        <li class="fm"><a class="hvr-sweep-to-right ftiles" href="javascript:void(0)"><span class="blurb2">Creative Writing</span></a>
        </li>
       </ul>
