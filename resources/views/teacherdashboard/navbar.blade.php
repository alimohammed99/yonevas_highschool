<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
 ...
 <!-- <img src="" alt=""> -->
       <img src="{{ asset('StaffImages/'.$data->staff_image) }}" alt="Staff Image" class="rounded-circle" style="border-radius:100px" width="200" height="300">
      ...
      @include("teacherdashboard.sidebar")
        <main class="content">
    ...
    <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav align-items-center">
        <li class="nav-item dropdown">
          <a class="nav-link text-dark notification-bell dropdown-toggle" style="width:100%; background-color:; padding:20px; border-radius:20px; border-bottom:20px groove tomato; border-top:20px groove tomato" data-unread-notifications="flase" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"><span class="badge badge-danger">
            ...
            <svg style="font-size:30px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope pl-1" viewBox="0 0 16 16">
              <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"/>
            </svg>
          </a>
          <div style="width:100%" class="dropdown-menu dropdown-menu-lg dropdown-menu-center mt-2 py-0">
              ...
              <div class="list-group-item list-group-item-action border-bottom">
                <div class="row align-items-center">
                    <div class="col-auto">
                     ...
                     @foreach($staffCircular as $staffCircular)
                    <div style="border-bottom:2px solid grey" class="col-12 ps-0 ms-2">
                      <h2 class="text-success pt-2">{{ $staffCircular->title }}</h2>
                      <div class="d-flex justify-content-between align-items-center">
                          ...
                          <p class="font-small mt-3 mb-0">{{ $staffCircular->content }}  </p>

                      </div>
                      <a href="{{ route('read', $staffCircular->id) }}" class="btn btn-success">Mark as read</a> <br><br>
