        ...
        <div class="body-here">
            <div class="main-here">
                ...
                <div class="signup-here">
                    ...
                    @endif
                    <x-jet-validation-errors style="color:red; font-weight:bold; margin:10px" class="mb-5" />
                    ...
                    <div>
                        ...
                        <button class="button-here" type="button"
                            onclick="alert('Sorry, this is currently undergoing maintenance')">Sign in</button>
